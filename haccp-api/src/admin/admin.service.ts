...
export class AdminService {
  ...
  /**
   * Update subscription status (ACTIVE, PAST_DUE, CANCELED, LOCKED_MANUAL)
   */
    ...
    if (notes) {
      await this.prisma.billingEvent.create({
        data: {
          ...
          description: `Statut mis à jour vers ${status}. Notes: ${notes}`,
        },
      });
    }
  ...
  async createEstablishment(
    ...
    await this.prisma.subscription.create({
      data: {
        ...
        status: activateSubscription ? SubscriptionStatus.ACTIVE : SubscriptionStatus.PAST_DUE,
    ...
    return {
      ...
      subscriptionStatus: activateSubscription ? SubscriptionStatus.ACTIVE : SubscriptionStatus.PAST_DUE,
    };
  }
